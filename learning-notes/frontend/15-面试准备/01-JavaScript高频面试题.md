...
<!-- version-check: ES2025/2026, TypeScript 6.0/7.0 Beta, Node.js 24 LTS, checked 2026-05-20 -->
...
A: TypeScript 7.0 Beta 已发布（2026-05），用 Go 重写编译器：
   ...
   当前稳定版 6.0（2026-03-23 发布），7.0 Beta 已可试用。
   <!-- 修复于 2026-05-20: TS 6.0 已发布，7.0 Beta 已发布，更新时间线 -->
...
A: 代号 Krypton（2025-04 发布，2025-10 进入 LTS）：
   ...
   - 支持至 2028-04
   - require(esm) 默认启用
   当前最新 LTS 版本：24.15.0（2026-04-15）
   <!-- 修复于 2026-05-20: 补充当前最新版本号 -->

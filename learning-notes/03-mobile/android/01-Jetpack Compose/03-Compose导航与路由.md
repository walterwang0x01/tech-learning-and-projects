...
<!-- version-check: Navigation Compose 2.9.8, Navigation 3 1.1.4 stable (1.2.0-alpha05), Kotlin 2.4.0, checked 2026-07-08 -->

> 🔄 更新于 2026-05-04（2026-07-08 校准 Navigation 3 1.1.4）
...
### Navigation 3（1.1.4 稳定版）

Navigation 3 是全新的 Compose-first 导航库，已于 2025-11 发布 1.0 稳定版，当前最新稳定版为 **1.1.4**（2026-07，Google Maven 实测），1.2.0 处于 alpha 阶段（最新 alpha05）。

```kotlin
// Navigation 3 核心概念：开发者完全拥有 back stack
// 依赖: implementation("androidx.navigation3:navigation3-runtime:1.1.4")

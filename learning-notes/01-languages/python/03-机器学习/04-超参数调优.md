...
<!-- version-check: optuna 4.9.x, keras-tuner 1.4.x, scikit-learn 1.9.x, checked 2026-07-10 -->
<!-- 修复于 2026-07-10: scikit-learn 1.7.x → 1.9.x（与本目录 03-模型评估与验证.md 保持一致），optuna 4.x → 4.9.x -->

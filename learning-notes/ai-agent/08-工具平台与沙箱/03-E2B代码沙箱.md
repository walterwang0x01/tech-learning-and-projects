    ...
    with Sandbox() as sandbox:
        while True:
            response = client.chat.completions.create(
                model="gpt-5.6", messages=messages, tools=tools,  # <!-- 修复于 2026-07-10: gpt-5.2 → gpt-5.6（2026-07-09 发布） -->
            )
...
<!-- version-check: E2B Build System 2.0（@e2b/code-interpreter 2.6.1，2026-06-17），JS SDK 默认启用 HTTP/2, checked 2026-07-10 -->

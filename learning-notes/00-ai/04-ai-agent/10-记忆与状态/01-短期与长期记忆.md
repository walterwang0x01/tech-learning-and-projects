...
# 完整对话历史（适合短对话）
# <!-- 修复于 2026-07-10: gpt-5.2 已过时，更新为 gpt-5.6（GPT-5.6 家族已于 2026-07-09 GA，别名路由到旗舰 Sol） -->
memory = ConversationBufferMemory(return_messages=True)
chain = ConversationChain(llm=ChatOpenAI(model="gpt-5.6"), memory=memory)
...
# 超过 token 限制时自动摘要
# <!-- 修复于 2026-07-10: gpt-5-mini 已过时，更新为 gpt-5.6-luna（GPT-5.6 家族最经济高频层级，适合摘要类轻量任务） -->

...
> ⚠️ **以下为 2026-08-03 补写前的诊断快照。** 所有标 ❌ / ⚠️ 的缺口已在第一轮（50 篇）和第二轮（10 篇）中全部补齐，执行状态见 [§8](#8-执行状态)。当前全部概念均有独立原理篇。
...
| `00-ai/03-实战项目/` | 2 | PyTorch 训练实战、端到端项目实战 |
...
00-ai/00-入门准备/03-学习路线与常见误区        ← 知道怎么走
        ↓
如果 Python 不熟：01-languages/python/00-Python基础（选 8 篇）+ 02-数据分析/02-NumPy
        ↓
00-ai/01-machine-learning/04-神经网络原理/02-反向传播推导   ← 正式起点
（数学卡住就查 00-数学基础/，不要先补完）
```
